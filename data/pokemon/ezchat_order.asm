...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, YVELTAL, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, PALKIA, PRIMEAPE, SENTRET, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, DIALGA, CLOYSTER, TYRANITAR, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, GIRATINA, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, GROUDON, -1
