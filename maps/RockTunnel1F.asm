...
RockTunnel1F_MapEvents:
	...
	object_event 11, 20, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnel1FFieldMon1Script, EVENT_FIELD_MON_1
	object_event 12, 10, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnel1FFieldMon2Script, EVENT_FIELD_MON_2
	object_event 21,  5, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnel1FFieldMon3Script, EVENT_FIELD_MON_3
	object_event 27, 17, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnel1FFieldMon4Script, EVENT_FIELD_MON_4
	object_event  4,  5, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnel1FFieldMon5Script, EVENT_FIELD_MON_5
