...
FalknerGroup:
	...
	db 14, STARAVIA, SHARP_BEAK, QUICK_ATTACK, PECK, CUT, SAND_ATTACK
...
WhitneyGroup:
	...
	db 27, CLEFABLE, POLKADOT_BOW, DRAIN_KISS, THUNDER_WAVE, FIRE_PUNCH, THUNDERPUNCH
	db 28, TOGEKISS, NO_ITEM,  THUNDER_WAVE, DRAIN_KISS, ANCIENTPOWER, ROOST
...
BugsyGroup:
	...
	db 19, PINSIR, BERRY, SEISMIC_TOSS, SCRATCH, WRAP, NO_MOVE
	db 21, SCYTHER, SILVERPOWDER, QUICK_ATTACK, PURSUIT, FURY_CUTTER, NO_MOVE
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_HEAD
	db -1 ; end
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGON_PULSE
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGON_PULSE
...
Rival1Group:
	...
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, NIGHT_SLASH
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, NIGHT_SLASH, FURY_CUTTER
...
WillGroup:
	...
	db 40, SIGILYPH,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	...
	db 42, SIGILYPH,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 42, KLEFKI,  PURSUIT, QUICK_ATTACK, DIG, PROTECT
	db 42, SOLOSIS,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 42, DUOSION, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, ONIX,       WRAP, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, ROCK_SMASH, DYNAMICPUNCH
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 42, UMBREON,    SAND_ATTACK, CONFUSE_RAY, NIGHT_SLASH, MEAN_LOOK
	db 42, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 45, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, NIGHT_SLASH
...
KogaGroup:
	...
	db 42, FERROTHORN,        HARDEN, ACID_ARMOR, SLUDGE_BOMB, TOXIC
...
ChampionGroup:
	...
	db 47, DRAGONITE,  THUNDER_WAVE, DRAGON_PULSE, THUNDER, HYPER_BEAM
	db 47, DRAGONITE,  THUNDER_WAVE, DRAGON_PULSE, BLIZZARD, HYPER_BEAM
...
BrockGroup:
	...
	db 42, KIRLIA,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       WRAP, ROCK_SLIDE, HARDEN, SANDSTORM
	db 42, GALADE,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 42, GOLDUCK,    SURF, DISABLE, PSYCHIC_M
...
LtSurgeGroup:
	...
	db 40, ELECTRODE,  SCREECH, SWIFT, EXPLOSION
	db 40, MAGNETON,   LOCK_ON, SWIFT, ZAP_CANNON
	db 40, ELECTRODE,  SCREECH, SWIFT, EXPLOSION
...
ErikaGroup:
	...
	db 42, WEAVILE,    VINE_WHIP, WRAP, GIGA_DRAIN, SLEEP_POWDER
	db 41, CONKELDURR,   MEGA_DRAIN, LEECH_SEED, HEADBUTT, GIGA_DRAIN
	db 46, VICTREEBEL, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 46, SYLVEON,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
JanineGroup:
	...
	db 39, VOLCARONA,   FORESIGHT, GUST, PSYCHIC_M
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 41, SNEASEL,    QUICK_ATTACK, SCREECH, NIGHT_SLASH, FURY_CUTTER
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, INFERNAPE, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, SNEASEL,    QUICK_ATTACK, SCREECH, NIGHT_SLASH, FURY_CUTTER
...
BlaineGroup:
	...
	db 45, DEOXYS,   CURSE, POISON_GAS, FLAMETHROWER, ROCK_SLIDE
...
RedGroup:
	...
	db 73, ESPEON,     MAGNITUDE, REFLECT, SWIFT, PSYCHIC_M
...
BlueGroup:
	...
	db 58, GYARADOS,   DRAGON_PULSE, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
