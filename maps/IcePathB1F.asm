...
IcePathB1F_MapEvents:
	...
	object_event  8, 13, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, IcePathB1FieldMon1Script, EVENT_FIELD_MON_1
	object_event 17, 11, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, IcePathB1FieldMon2Script, EVENT_FIELD_MON_2
	object_event 15, 25, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, IcePathB1FieldMon3Script, EVENT_FIELD_MON_3
