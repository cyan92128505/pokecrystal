...
Route41_MapEvents:
	...
	object_event 40,  4, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route41FieldMon1Script, EVENT_FIELD_MON_1
	object_event  7,  2, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route41FieldMon2Script, EVENT_FIELD_MON_2
	object_event 47,  26, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route41FieldMon3Script, EVENT_FIELD_MON_3
	object_event 22,  27, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 4, Route41FieldMon4Script, EVENT_FIELD_MON_4
	object_event 26,  50, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route41FieldMon5Script, EVENT_FIELD_MON_5
	object_event  4, 38, SPRITE_LAPRAS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route41FieldMon6Script, EVENT_FIELD_MON_6
