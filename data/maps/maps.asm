...
MapGroup_Dungeons:
	...
	map SproutTowerB1F, TILESET_TOWER, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_SPROUT_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map SilverCaveRoom3, TILESET_CAVE, INDOOR, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_LAKE
