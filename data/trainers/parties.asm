...
PicnickerGroup:
    ...
    db  100, MACHAMP
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db QUICK_CLAW
        db DYNAMICPUNCH, ICE_PUNCH, BULLET_PUNCH, THUNDERPUNCH
    db  100, GROUDON
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
...
CamperGroup:
	...
	;db 10, ZUBAT
	;db 14, DIGLETT
    db "CYNTHIA@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
    db  100, SPIRITOMB
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
        db CALM_MIND, DARK_PULSE, REST, SLEEP_TALK
    db  100, LUCARIO
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db FOCUS_SASH
       	db SWORDS_DANCE, CLOSE_COMBAT, EXTREMESPEED, ROCK_SLIDE
	db  100, QUAGSIRE
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
