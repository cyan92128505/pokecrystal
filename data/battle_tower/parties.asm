...
; BattleTowerMons group 1
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_HEAD, PSYCH_UP, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db HOUNDOUR
	db GOLD_BERRY
	db NIGHT_SLASH, SOLARBEAM, ROAR, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db TOXIC, GIGA_DRAIN, SHADOW_BALL, CONFUSION
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db BLASTOISE
	db QUICK_CLAW
	db HYDRO_PUMP, ICE_PUNCH, HYPER_BEAM, IRON_HEAD
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 30000
...
; ============ Below are considered not Uber ===============
	...
	db RAIKOU
	db MAGNET
	db VOLT_TACKLE, THUNDERBOLT, DARK_PULSE, HIDDEN_POWER ; ice
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
...
; ================ Final trainer doesn't use pokes below here =============
	...
	db PIKACHU
	db LIGHT_BALL
	db VOLT_TACKLE, THUNDERBOLT, SURF, HIDDEN_POWER ; ice
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
	...
	db CHANDELURE
	db LIFE_ORB
	db FIRE_BLAST, SHADOW_BALL, GIGA_DRAIN, AURA_SPHERE
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
