...
Museum_MapEvents:
	...
	object_event 16, 29, SPRITE_MONSTER, SPRITEMOVEDATA_SPINCLOCKWISE, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, MuseumFieldMon9Script, EVENT_FIELD_MON_9
	object_event 16, 27, SPRITE_MONSTER, SPRITEMOVEDATA_SPINCLOCKWISE, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, MuseumFieldMon10Script, EVENT_FIELD_MON_10
