...
Route43_MapEvents:
	...
	object_event 14,  9, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route43FieldMon1Script, EVENT_FIELD_MON_1
	object_event 20, 15, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 2, 2, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route43FieldMon2Script, EVENT_FIELD_MON_2
