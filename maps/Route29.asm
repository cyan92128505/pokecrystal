...
Route29_MapEvents:
	...
	object_event 38, 12, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route29FieldMon1Script, EVENT_FIELD_MON_1
	;object_event 19,  8, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 2, 2, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route29FieldMon2Script, EVENT_FIELD_MON_2
