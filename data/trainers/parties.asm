...
JugglerGroup:
    ...
    db 100, OMASTAR
        db PERFECT_DV, PERFECT_DV
       	...
       	db SHELL_SMASH, HYDRO_PUMP, ICE_BEAM, ROCK_SLIDE
    db  100, ZAPDOS
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db LEFTOVERS
       	db THUNDER, DRILL_PECK, ICY_WIND, THUNDER_WAVE
    db  100, GENESECT
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db EXPERT_BELT
...
PokefanFGroup:
    ...
    db  100, MEW
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LIFE_ORB
       	db SWORDS_DANCE, EXPLOSION, ICE_PUNCH, EARTHQUAKE
	db  100, DARKRAI
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
       	db DARK_VOID, NASTY_PLOT, DARK_PULSE, AURA_SPHERE
    db  100, XERNEAS
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db PINK_BOW
       	db GEOMANCY, MOON_BLAST, SHADOW_BALL, AURA_SPHERE
    db  100, YVELTAL
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db SHARP_BEAK
