...
Route31_MapEvents:
	...
	object_event 40, 8, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route31FieldMon1Script, EVENT_FIELD_MON_1
	object_event 29, 2, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route31FieldMon2Script, EVENT_FIELD_MON_2
