...
MapGroup_Dungeons:
	...
	map SproutTowerB1F, TILESET_TOWER, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_DARK, FISHGROUP_SHORE
	...
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_ICE_PATH, DUNGEON, LANDMARK_SILVER_CAVE, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map DarkCaveVioletEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_MAD_WORLD, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_MAD_WORLD, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	...
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MAD_WORLD, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MAD_WORLD, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	...
	map CeruleanCave, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map WillsRoom, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map KogasRoom, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BrunosRoom, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map KarensRoom, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LancesRoom, TILESET_CHAMPIONS_ROOM, DUNGEON, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderTown, TILESET_KANTO, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavenderPokecenter1F, TILESET_POKECENTER, INDOOR, MUSIC_MAD_WORLD, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	;map LavenderPokecenter2FBeta, TILESET_POKECENTER, INDOOR, MUSIC_MAD_WORLD, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrFujisHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderNameRater, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderMart, TILESET_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SoulHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_RADIO_TOWER, MUSIC_MAD_WORLD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderForest, TILESET_JOHTO, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_MAD_WORLD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_DestinyTower:
	...
	map DestinyFrontier, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, LANDMARK_DESTINY_TOWER, MUSIC_MYSTICALMAN_ENCOUNTER, TRUE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_AncientRuin:
	...
	map AncientRuinPast, TILESET_JOHTO, INDOOR, LANDMARK_ANCIENT_RUIN, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
