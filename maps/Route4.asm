...
Route4_MapEvents:
	...
	object_event 18, 11, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route4FieldMon1Script, EVENT_FIELD_MON_1
	object_event 27, 14, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route4FieldMon2Script, EVENT_FIELD_MON_2
