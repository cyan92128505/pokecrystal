...
; BattleTowerMons group 10
    ...
    db MAROWAK
	db THICK_CLUB
	db SWORDS_DANCE, EARTHQUAKE, RETURN, ROCK_SLIDE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db SKARMORY
	db LEFTOVERS
	db DRILL_PECK, CURSE, REST, WHIRLWIND
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db STEELIX
	db LEFTOVERS
	db CURSE, EARTHQUAKE, REST, IRON_TAIL
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db HOUNDOOM
	db LEFTOVERS
	db FLAMETHROWER, CRUNCH, REST, SLEEP_TALK
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db DRAGONITE
	db LEFTOVERS
	db DOUBLE_EDGE, DYNAMICPUNCH, THUNDER, FIRE_BLAST
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db RAIKOU
	db LEFTOVERS
	db THUNDERBOLT, CRUNCH, REST, SLEEP_TALK
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db ZAPDOS
	db LEFTOVERS
	db THUNDERBOLT, DRILL_PECK, DOUBLE_TEAM, REST
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db SNORLAX
	db LEFTOVERS
	db RETURN, EARTHQUAKE, CURSE, REST
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db SNORLAX
	db LEFTOVERS
	db DOUBLE_EDGE, CURSE, REST, SLEEP_TALK
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db MEW
	db MIRACLEBERRY
	db SWORDS_DANCE, EARTHQUAKE, RETURN, SOFTBOILED
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db HO_OH
	db LEFTOVERS
	db RETURN, EARTHQUAKE, SACRED_FIRE, RECOVER
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
	...
	db LUGIA
	db LEFTOVERS
	db AEROBLAST, EARTHQUAKE, CURSE, RECOVER
	dw 0 ; OT ID
	dt 1250000 ; Exp
	; Stat exp
	bigdw 65500
