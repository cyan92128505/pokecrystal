...
Route44_MapEvents:
	...
	object_event 49,  5, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 3, 3, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route44FieldMon1Script, EVENT_FIELD_MON_1
	object_event 48, 16, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 3, 3, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route44FieldMon2Script, EVENT_FIELD_MON_2
