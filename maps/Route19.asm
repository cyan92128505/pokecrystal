...
Route19_MapEvents:
	...
	object_event  5, 20, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_FAST, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route19FieldMon1Script, EVENT_FIELD_MON_1
	object_event 14, 22, SPRITE_SURF, SPRITEMOVEDATA_SPINRANDOM_FAST, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route19FieldMon2Script, EVENT_FIELD_MON_2
