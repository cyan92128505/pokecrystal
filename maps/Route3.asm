...
Route3_MapEvents:
	...
	object_event 28,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route3FieldMon1Script, EVENT_FIELD_MON_1
	object_event 39,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route3FieldMon2Script, EVENT_FIELD_MON_2
