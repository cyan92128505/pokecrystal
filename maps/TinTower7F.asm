...
TinTower7F_MapEvents:
	...
	object_event  5,  2, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, TinTower7FFieldMon1Script, EVENT_FIELD_MON_1
	object_event  7,  7, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, TinTower7FFieldMon2Script, EVENT_FIELD_MON_2
