...
MapGroup_Dungeons:
	...
	map SilverCaveRoom3, TILESET_ICE_PATH, DUNGEON, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_LAKE
...
MapGroup_Silver:
	...
	map SilverCaveOutside, TILESET_KANTO, TOWN, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCavePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_DestinyTower:
	...
	map DestinyPark, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, LANDMARK_DESTINY_TOWER, MUSIC_MYSTICALMAN_ENCOUNTER, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map DestinySquare, TILESET_BATTLE_TOWER_INSIDE, INDOOR, LANDMARK_DESTINY_TOWER, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_DESTINY_TOWER_MAPS

MapGroup_HallOfOrigin:
	table_width MAP_LENGTH, MapGroup_HallOfOrigin
	map HallOfOrigin, TILESET_PARK, ROUTE, LANDMARK_HALL_OF_ORIGIN, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_AncientRuin:
	...
	map AncientRuinPresent, TILESET_JOHTO, INDOOR, LANDMARK_ANCIENT_RUIN, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_NITE, FISHGROUP_NONE
