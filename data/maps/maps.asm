...
MapGroup_Dungeons:
	...
	map SproutTowerB1F, TILESET_TOWER, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
...
MapGroup_AncientRuin:
	...
	map AncientRuinPast, TILESET_JOHTO, INDOOR, LANDMARK_ANCIENT_RUIN, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_EVE, FISHGROUP_NONE
