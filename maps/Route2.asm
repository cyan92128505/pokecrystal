...
Route2_MapEvents:
	...
	object_event 15, 14, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, Route2FieldMon1Script, EVENT_FIELD_MON_1
	...
	object_event  5,  7, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route2FieldMon3Script, EVENT_FIELD_MON_3
	object_event  5, 18, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, DAY, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route2FieldMon4Script, EVENT_FIELD_MON_4
	...
	object_event  2, 22, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route2FieldMon6Script, EVENT_FIELD_MON_6
	...
	object_event  3, 34, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route2FieldMon8Script, EVENT_FIELD_MON_8
