...
MountMortarB1F_MapEvents:
	...
	object_event 30, 11, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortarB1FFieldMon1Script, EVENT_FIELD_MON_1
	object_event  2, 17, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortarB1FFieldMon2Script, EVENT_FIELD_MON_2
