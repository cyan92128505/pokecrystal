...
MapGroup_Violet:
	...
	map Route37, TILESET_JOHTO, CAVE, LANDMARK_ROUTE_37, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderForest, TILESET_JOHTO, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_SHORE
