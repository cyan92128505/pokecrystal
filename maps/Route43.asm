...
Route43_MapEvents:
	...
	object_event  9, 30, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route43FieldMon5Script, EVENT_FIELD_MON_5
	object_event 18, 13, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route43FieldMon6Script, EVENT_FIELD_MON_6
