...
IcePathB3F_MapEvents:
	...
	object_event  8, 12, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, IcePathB3FFieldMon1Script, EVENT_FIELD_MON_1
	object_event  7, 14, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, IcePathB3FFieldMon2Script, EVENT_FIELD_MON_2
	object_event 10, 14, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, IcePathB3FFieldMon3Script, EVENT_FIELD_MON_3
