...
MountMortar1FInside_MapEvents:
	...
	object_event 20, 45, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortar1FInsideFieldMon1Script, EVENT_FIELD_MON_1
	object_event 16, 31, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortar1FInsideFieldMon2Script, EVENT_FIELD_MON_2
	object_event 27, 40, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortar1FInsideFieldMon3Script, EVENT_FIELD_MON_3
	object_event 21, 27, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortar1FInsideFieldMon4Script, EVENT_FIELD_MON_4
	object_event 12, 26, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, MountMortar1FInsideFieldMon5Script, EVENT_FIELD_MON_5
