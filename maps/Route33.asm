...
Route33FieldMon3Script:
	trainer GOLBAT, FIELD_MON, EVENT_FIELD_MON_3, Route33PokemonAttacksText, 36, 0, .script
.script
...
Route33_MapEvents:
	...
	object_event 6, 10, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route33FieldMon3Script, EVENT_FIELD_MON_3
