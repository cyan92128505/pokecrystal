...
PicnickerGroup:
	...
	db  100, GYARADOS
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
       	db DRAGON_DANCE, WATERFALL, EARTHQUAKE, DOUBLE_EDGE
    db  100, METAGROSS
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db QUICK_CLAW
    ...
    db  100, MACHAMP
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db QUICK_CLAW
        db DYNAMICPUNCH, ICE_PUNCH, EARTHQUAKE, THUNDERPUNCH
    db  100, GROUDON
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
...
CamperGroup:
    ...
    db  100, MEW
       	...
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db LEFTOVERS
       	db SWORDS_DANCE, EARTHQUAKE, DOUBLE_EDGE, SOFTBOILED
    db  100, CHANDELURE
        db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db CHOICE_SPECS
    ...
    db  100, SNORLAX
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db LEFTOVERS
        db CURSE, DOUBLE_EDGE, REST, SLEEP_TALK
    db  100, YVELTAL
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db SHARP_BEAK
