...
ScientistGroup:
	...
	db 30, PORYGON,    SHADOW_BALL, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
ErikaGroup:
	...
	db 41, CONKELDURR,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
...
;       	db SACRED_FIRE, CLOSE_COMBAT, EARTHQUAKE, EXTREMESPEED
	...
	db 33, CONKELDURR,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
	db 33, CONKELDURR,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
