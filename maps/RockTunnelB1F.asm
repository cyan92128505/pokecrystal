...
RockTunnelB1F_MapEvents:
	...
	object_event 20, 32, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnelB1FFieldMon1Script, EVENT_FIELD_MON_1
	object_event 19, 25, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnelB1FFieldMon2Script, EVENT_FIELD_MON_2
	object_event 22, 13, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnelB1FFieldMon3Script, EVENT_FIELD_MON_3
	object_event  7, 16, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnelB1FFieldMon4Script, EVENT_FIELD_MON_4
	object_event 15, 17, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, RockTunnelB1FFieldMon5Script, EVENT_FIELD_MON_5
