...
Route37_MapEvents:
	...
	object_event 4,   5, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route37FieldMon5Script, EVENT_FIELD_MON_5
	object_event 1,   9, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route37FieldMon6Script, EVENT_FIELD_MON_6
	object_event 15, 14, SPRITE_LASS, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route37FieldMon7Script, EVENT_FIELD_MON_7
	object_event 2,  19, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GOLD, OBJECTTYPE_SCRIPT, 0, Route37FieldMon8Script, EVENT_FIELD_MON_8
