...
Route11_MapEvents:
	...
	object_event 14,  8, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route11FieldMon1Script, EVENT_FIELD_MON_1
	object_event 29,  9, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, NITE, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, Route11FieldMon2Script, EVENT_FIELD_MON_2
