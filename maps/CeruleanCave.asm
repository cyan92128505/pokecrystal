...
CeruleanCave_MapEvents:
	...
	object_event  3, 16, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon2Script, EVENT_FIELD_MON_2
	...
	object_event 12, 51, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon5Script, EVENT_FIELD_MON_5
	object_event  7, 49, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon6Script, EVENT_FIELD_MON_6
	object_event 11,  1, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon7Script, EVENT_FIELD_MON_7
	...
	object_event 23, 14, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon9Script, EVENT_FIELD_MON_9
	object_event 23, 48, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 4, 4, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, CeruleanCaveFieldMon10Script, EVENT_FIELD_MON_10
