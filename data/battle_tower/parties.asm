...
; MASTER level
    ...
    db GIRATINA
	db LEFTOVERS
	db SHADOW_FORCE, DRACO_METEOR, NASTY_PLOT, RECOVER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db ZAPDOS ; 50 mons
	db LEFTOVERS
	db THUNDERBOLT, BRAVE_BIRD, ICY_WIND, ROOST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db BRELOOM
	db FOCUS_SASH
	db SPORE, SWORDS_DANCE, LEAF_BLADE, DRAIN_PUNCH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db REUNICLUS
	db LEFTOVERS
	db CALM_MIND, PSYCHIC_M, AURA_SPHERE, RECOVER
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
;	db "RANTA-N@@@@"
	...
	db CHANDELURE
	db CHARCOAL
	db NASTY_PLOT, FIRE_BLAST, SHADOW_BALL, GIGA_DRAIN
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
