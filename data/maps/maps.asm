...
MapGroup_Ecruteak:
	...
	map EcruteakGym, TILESET_TOWER, CAVE, LANDMARK_ECRUTEAK_CITY, MUSIC_GYM, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map LakeOfRageHiddenPowerHouse, TILESET_HOUSE, DUNGEON, LANDMARK_LAKE_OF_RAGE, MUSIC_RUINS_OF_ALPH_RADIO, FALSE, PALETTE_NITE, FISHGROUP_SHORE
