...
UnionCaveB1F_MapEvents:
	...
	object_event 10, 9, SPRITE_MONSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, UnionCaveB1FFieldMon2Script, EVENT_FIELD_MON_2
