...
UnionCaveB2F_MapEvents:
	...
	object_event 15, 29, SPRITE_SURF, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, UnionCaveB2FFieldMon1Script, EVENT_FIELD_MON_1
   	...
   	object_event  8, 4, SPRITE_DRAGON, SPRITEMOVEDATA_WANDER, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, UnionCaveB2FFieldMon3Script, EVENT_FIELD_MON_3
   	object_event  2, 26, SPRITE_DRAGON, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, UnionCaveB2FFieldMon4Script, EVENT_FIELD_MON_4
