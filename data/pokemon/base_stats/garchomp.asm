	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, BLIZZARD, ICE_BEAM, HYPER_BEAM, ICY_WIND, PROTECT, ENDURE, FRUSTRATION, IRON_HEAD, DRAGON_PULSE, THUNDER, RETURN, SLEEP_TALK, SANDSTORM, FIRE_BLAST, SWIFT, REST, X_SCISSOR, CUT, STRENGTH, FLY, EARTHQUAKE, EARTH_POWER, ROCK_SLIDE, FLAMETHROWER, THUNDERBOLT, THUNDER_WAVE, ICE_BEAM, SWORDS_DANCE, DIG
	; end
