...
MomItems_2:
	...
	momitem  20000,   600, MOM_ITEM, FOCUS_SASH
    ...
    momitem  90000, 25000, MOM_ITEM, LIFE_ORB
    momitem 100000, 30000, MOM_ITEM, CHOICE_BAND
    momitem 110000, 35000, MOM_ITEM, CHOICE_SPECS
	momitem 120000, 40000, MOM_ITEM, AMBROSIA
.End
