...
SchoolboyGroup:
	...
	db  120, PIKACHU
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIGHT_BALL
       	db THUNDERBOLT, DRAGON_PULSE, SURF, DOUBLE_EDGE
    db  100, SNORLAX
        db PERFECT_DV, PERFECT_DV
...
LassGroup:
	...
	db  100, LATIOS
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
       	db CALM_MIND, DRAGON_PULSE, THUNDERBOLT, RECOVER
    db  100, LUGIA
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
...
PokefanFGroup:
    ...
    db  100, DIALGA
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
       	db CURSE, DRAGON_CLAW, EARTHQUAKE, REST
    db  100, RAYQUAZA
     	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
        db LEFTOVERS
    ...
    db  100, GIRATINA
      	...
      	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
       	db CALM_MIND, DRAGON_PULSE, REST, SLEEP_TALK
	db -1 ; end
