...
MultiverseHeroes2Text:
    ...
    para "You are overcome"
    line "by his dark power."
    ...
    para "You feel a"
    line "strong connection"
    cont "with one."

    para "Could that be"
    line "THE FORCE itself."
...
MultiverseVillains1Text:
    ...
    para "A large man in"
    line "ancient looking"
    cont "and extravagant"
    cont "gold armour sits"
    cont "in a dark corner."

    para "You can sense he"
    line "contains many"
    cont "souls within him."
    ...
    line "dark cape stands"
    cont "talking to another"
    cont "large and wild"
    cont "looking man."

    para "The older man"
    line "has an unsettling"
    cont "grin and long"
    cont "fingers held in"
    cont "front of him."
    ...
    para "You sense huge"
    line "pride within him"
    cont "and nothing else."

    para "...."

    para "He is the"
    line "villain from the"
    cont "HOEN war story."
    ...
    para "You are not sure"
    line "what it is but"
    cont "you can tell it"
    cont "is pure evil."

    para "It effects every"
    line "person except the"
    cont "muscular man."

    para "The old man"
    line "suggests you"
    cont "head to the top"
    cont "of the tower."

    para "As your group"
    line "reaches the top"
    cont "you see another"
    cont "group."
    ...
    para "Your magic is no"
    line "match for his."

    para "But he would make"
    line "a great ally."
...
MultiverseVillains2Text:
    ...
    para "Just give SAURON"
    line "time to reach"
    cont "full power."

    para "SAURON launches"
    line "horrific attacks."
    ...
    para "His inhuman form"
    line "seems immovable."
...
MultiverseDeities1Text:
    ...
    cont "regal woman is"
    cont "in a mental"
    cont "connection with"
    cont "a similarly regal"
    cont "looking dragon."

    para "They both have"
    line "immense magical"
    cont "power."

    para "Not vulgar magic"
    line "but refined and"
    cont "pure."
    ...
    para "Something comes."

    para "Something beyond"
    line "any of you."
    ...
    para "ARCEUS informs all"
    line "that we are being"
    cont "tested."
    ...
    para "You can sense"
    line "that one of them"
    cont "is a FORCE user."

    para "And is a master of"
    line "the DARK side."
...
MultiverseDeities2Text:
    ...
    para "You begin battle"
    line "with him."

    para "He is not so"
    line "very strong."

    para "But difficult to"
    line "pin down."
    ...
    cont "interrupt his"
    cont "power up just"
    cont "long enough for"
    cont "ARCEUS to finish"
    cont "the group."
    ...
    para "But in a moment"
    line "you are renewed"
    cont "by ARCEUS."
    ...
    line "no different you"
    cont "are sure."

    para "It is clear what"
    line "your test is."
...
MultiverseRolePlayFinalText:
    ...
    para "Things are just"
    line "as they were"
    cont "before you were"
    cont "transported away."
