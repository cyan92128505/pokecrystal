...
.o:        db FERALIGATR, LUCARIO, PALKIA, PRIMEAPE, SENTRET, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ma:       db DEOXYS, LATIAS, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, GROUDON, -1
