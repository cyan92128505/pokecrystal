...
IlexForest_MapEvents:
	...
	object_event 24, 47, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, IlexForestFieldMon1Script, EVENT_FIELD_MON_1
   	object_event 27, 0, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 3, IlexForestFieldMon2Script, EVENT_FIELD_MON_2
