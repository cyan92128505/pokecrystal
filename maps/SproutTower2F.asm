...
SproutTower2F_MapEvents:
	...
	object_event 16,  6, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, SproutTower2FFieldMon1Script, EVENT_FIELD_MON_1
	object_event  2, 15, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 2, SproutTower2FFieldMon2Script, EVENT_FIELD_MON_2
