...
CamperGroup:
	...
	;db 10, ZUBAT
	;db 14, DIGLETT
    db "SABRINA@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
    db  100, ALAKAZAM
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db FOCUS_SASH
	...
	db  100, CELEBI
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
       	db CALM_MIND, PSYCHIC_M, EARTH_POWER, RECOVER
    db  100, PORYGONZ
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db LIFE_ORB
    ...
    db  100, LUGIA
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
       	db AEROBLAST, CALM_MIND, RECOVER, EARTH_POWER
    db -1 ; end
