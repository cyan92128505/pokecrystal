...
FalknerGroup:
	...
	db  7, STARLY,     TACKLE, SAND_ATTACK, NO_MOVE, NO_MOVE
	db  9, STARAVIA,  TACKLE, SAND_ATTACK, GUST, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 20, MILTANK,    ROLLOUT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 14, DOUBLADE,     POISON_STING, HARDEN, NO_MOVE, NO_MOVE
