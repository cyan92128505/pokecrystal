...
AncientHall_MapEvents:
	...
	object_event 2, 16, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 1, AncientHallFieldMon1Script, EVENT_FIELD_MON_1
