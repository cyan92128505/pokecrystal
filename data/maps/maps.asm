...
MapGroup_Dungeons:
	...
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_RED_INDIGO_PLATEAU, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	...
	map DarkCaveVioletEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_RED_DUNGEON, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map DarkCaveBlackthornEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_RED_DUNGEON, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	...
	map AncientTemple, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DARK, FISHGROUP_NONE
...
MapGroup_Lavender:
	...
	map LavenderPokecenter1F, TILESET_POKECENTER, INDOOR, MUSIC_RED_LAVENDER, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	;map LavenderPokecenter2FBeta, TILESET_POKECENTER, INDOOR, MUSIC_RED_LAVENDER, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_AncientRuin:
	...
	map AncientRuinPresent, TILESET_JOHTO, CAVE, LANDMARK_ANCIENT_RUIN, MUSIC_MAD_WORLD, TRUE, PALETTE_NITE, FISHGROUP_NONE
