...
WillGroup:
	...
	db 100, PIKACHU,    REST, DOUBLE_EDGE, THUNDERBOLT, CURSE
	db 73, MACHAMP,     CROSS_CHOP, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db 75, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 77, TYRANITAR,   CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db 77, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, BLASTOISE,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end

	;db "WILL@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	;db  100, ARCEUS
...
FisherGroup:
	...
	db 35, QWILFISH,   TOXIC, HARDEN, SURF, PIN_MISSILE
