...
LassGroup:
    ...
    db  100, GARCHOMP
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db CHOICE_BAND
       	db OUTRAGE, NO_MOVE, NO_MOVE, NO_MOVE
    db  100, PALKIA
     	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
        db LIFE_ORB
       	db CALM_MIND, SURF, ICE_BEAM, THUNDERBOLT
    db  100, DIALGA
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db LEFTOVERS
       	db CURSE, EARTHQUAKE, DRAGON_CLAW, REST
    db  100, GIRATINA
       	db PERFECT_DV, PERFECT_DV
      	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
       	db CALM_MIND, DRAGON_PULSE, REST, SHADOW_BALL
    db  100, RAYQUAZA
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
       	db DRAGON_DANCE, SKY_CLEAVE, EARTHQUAKE, OUTRAGE
	db -1 ; end
...
FirebreatherGroup:
	...
	db  100, GYARADOS
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
       	db DRAGON_DANCE, WATERFALL, EARTHQUAKE, HYDRO_PUMP
    db  100, GARCHOMP
       	db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db MIRACLEBERRY
    ...
    db  100, LATIAS
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
       	db DRAGON_PULSE, CALM_MIND, REST, SLEEP_TALK
	db -1 ; end
...
JugglerGroup:
    ...
    db  100, PALKIA
        ...
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LIFE_ORB
       	db HYDRO_PUMP, THUNDER, ICE_BEAM, DRAGON_PULSE
    db  100, LATIOS
        db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db FOCUS_SASH
        db DRAGON_PULSE, SURF, CALM_MIND, THUNDER
	db -1 ; end
...
PsychicGroup:
    ...
    db  100, RAIKOU
        db PERFECT_DV, PERFECT_DV
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
       	db LEFTOVERS
       	db CALM_MIND, THUNDERBOLT, DARK_PULSE, REST
	db  100, ENTEI
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db LEFTOVERS
    ...
    db  100, CELEBI
       	...
       	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
      	db LEFTOVERS
       	db PSYCHIC_M, GIGA_DRAIN, CALM_MIND, RECOVER
    db  100, HO_OH
       	db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP
       	db SHARP_BEAK
       	db BRAVE_BIRD, SACRED_FIRE, EARTHQUAKE, RECOVER
    db  100, LUGIA
        db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db LEFTOVERS
...
PicnickerGroup:
    ...
    db  100, METAGROSS
      	...
      	db CHOICE_BAND
       	...
       	db METEOR_MASH, NO_MOVE, NO_MOVE, NO_MOVE
    db  100, TYRANITAR
        db PERFECT_DV, PERFECT_DV
        dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
        db LEFTOVERS
